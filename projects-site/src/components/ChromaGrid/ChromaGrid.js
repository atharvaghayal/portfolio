    ...
    >
      {data.map((c, i) => (
        ...
        >
          ...
          {/* Always render the icon; if no URL, render disabled state and prevent navigation */}
          <a
            ...
            onClick={(e) => {
              // Stop card click either way; if no URL, prevent navigation
              e.stopPropagation();
            ...
            tabIndex={c.url ? 0 : -1}
          >
            <img src={externalIcon} alt="external link" width="16" height="16" />
          </a>
        </article>
      ))}
